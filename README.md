...
IOC Extraction: Identifying and cataloging indicators of compromise (IPs, domains, malware hashes).
...
Threat Intelligence Platforms: VirusTotal and others for IOC verification.

MITRE ATT&CK Framework: Mapping behaviors to adversary tactics and techniques.
